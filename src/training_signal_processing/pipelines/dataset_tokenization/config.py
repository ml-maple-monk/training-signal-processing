...
class DatasetTokenizationRecipeConfigLoader(config_loading.AbstractRecipeConfigLoader):
...
dataset_tokenization_recipe_config_loader = DatasetTokenizationRecipeConfigLoader()
...
def load_recipe_config(
    ...
    *,
    ...
    dataset_tokenization_recipe_config_loader.current_machine_path = CURRENT_MACHINE_PATH
    return dataset_tokenization_recipe_config_loader.load_recipe_config(
        config_path,
        overrides,
...
def load_resolved_recipe_mapping(
    ...
    *,
    ...
    dataset_tokenization_recipe_config_loader.current_machine_path = CURRENT_MACHINE_PATH
    return dataset_tokenization_recipe_config_loader.load_resolved_recipe_mapping(
        config_path,
        overrides,
        overlay_paths=overlay_paths,
    )
...
def build_recipe_config(raw: dict[str, Any], config_path: Path) -> RecipeConfig:
    return dataset_tokenization_recipe_config_loader.build_recipe_config(raw, config_path)
