...
class UnifiedDataRecipeConfigLoader(config_loading.AbstractRecipeConfigLoader):
...
unified_data_recipe_config_loader = UnifiedDataRecipeConfigLoader()
...
def load_recipe_config(
    ...
    *,
    ...
    unified_data_recipe_config_loader.current_machine_path = CURRENT_MACHINE_PATH
    return unified_data_recipe_config_loader.load_recipe_config(
        config_path,
        overrides,
...
def load_resolved_recipe_mapping(
    ...
    *,
    ...
    unified_data_recipe_config_loader.current_machine_path = CURRENT_MACHINE_PATH
    return unified_data_recipe_config_loader.load_resolved_recipe_mapping(
        config_path,
        overrides,
        overlay_paths=overlay_paths,
    )
...
def build_recipe_config(raw: dict[str, Any], config_path: Path) -> RecipeConfig:
    return unified_data_recipe_config_loader.build_recipe_config(raw, config_path)
